...
date: "2025-07-15"
summary: "Как получить данные по вершинам и перевалам в приличном виде."
description: "Как получить данные по вершинам и перевалам в приличном виде."
toc: true
autonumber: false
math: false
tags: ["ГИС"]
...
Ответы на всякие ЧаВо лучше смотреть у [самой Вестры](https://westra.ru/passes/geohelp.php).
...
Каталог Вестры для GE - не содержит самих данных. Есть только ссылка подключения:
...
Просто перейдя по ссылке - скачать данные не получится. По всей видимости ожидаются специальные referer-ы и параметры типа охвата. Выяснить можно, но муторно. Таким образом из самого GE ссылка работает, отдельно - нет.
