...
Как обычно, многое еще требует уточнения, но уже сейчас с достаточной точностью можно утверждать насколько были схожи маршруты [Цыбикова](/notes/tsybikov-map/), [Норзунова](/notes/norzunov-route/) или [Джунгруева](/notes/jungruev-toponyms/). Подробнее см. статью [Pilgrim routes to Tibet](/notes/pilgrim-ways-to-tibet/).

Здесь приведена карта приведена объединяющая маршруты паломников.
