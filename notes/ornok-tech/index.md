...
У студентов на телефонах был заранее проверен режим фотографирования, убедилисьч, что GPS координаты записываются в EXIF фотографий, выданы линейки.

В поле студентам был обозначен примерный квадрат работ. Был опробован режим отслеживания себя в поле с учетом границ нужных квадратов на мобильной версии Веб карты. Функция "Locate me" позволяет увидеть свой маркер на карте и непрерывно отслеживать его местоположение. Особое преимущество этого способа в том, что не нужно ставить никаких дополнительных приложений, подходит любой современный мобильный браузер.
