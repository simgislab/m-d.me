...
* Нужно обязательно проверять телефоны до выхода, так как у некоторых моделей координаты для скорости могут привязываться к ближайшим Wi-fi точкам и точки будут оказываться в населенных пунктах.
