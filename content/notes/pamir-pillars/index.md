...
![final-map.png](final-map.png "Зеленые кресты - исходные координаты, синие кресты - результаты пересчета. Красная линия - граница Таджикистана и Афганистана из OpenStreetMap")

## Вопросы?

Возникли вопросы, комментарии или есть полезная информация по теме заметки?

Можно [**написать в телеграм**](https://t.me/answer42geo/143) или оставить вопрос в форме ниже.
