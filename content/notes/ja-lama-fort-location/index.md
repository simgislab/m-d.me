...
![fort-location-map.png](fort-location-map.png "Расположение крепости Джа-ламы и некоторые основные топонимы.")

![fortress-google-sat.png](fortress-google-sat.png "Руины крепости на Google Maps (Satellite).")
...
![lattimore-caravan-routes-map-zoom.png](lattimore-caravan-routes-map-zoom.png "The principle caravan routes of Inner Asia.")
...
![lattimore-caravan-routes-map2-zoom.png](lattimore-caravan-routes-map2-zoom.png "Caravan routes from China to Central Asia, showing Mr. Lattimore's route from Kweihwa to Kuchengtze")
...
Никаких объектов подобных крепости на снимках в окрестностях данного родника не обнаружено.
...
Можно [**написать в телеграм**](https://t.me/answer42geo/215) или оставить вопрос в форме ниже.
