...
Display the Loop plugin’s content. Упоминаемый раздел это не раздел в Config builder, в нем всегда включенная и засеренная галка и пустой раздел настройки. Чтобы пройти задачу, нужно нажать гамбургер и выбрать Loop в нём.
...
Перед тем как сдаваться и писать, попробуйте сначала ответить сами, почитайте официальную документацию на [русском](https://androidaps.readthedocs.io/ru/latest/) или на [английском](https://androidaps.readthedocs.io/en/latest/).
