...
Перед началом данной работы Коросовым была создана локальная ГИС в QGIS. Эта ГИС легла в основу дальнейшей работы.
...
Исходя из упомянутых выше недостатков, сразу конвертируем локальную ГИС в Веб с помощью **NextGIS Connect**.
...
Можно сказать, что один проект QGIS превращается в одну Веб карту.
...
## Навигация и использование данных в поле
...
Наличие продвинутого средства командной работы не отменяет необходимости в полноценных геоботанических описаниях, но значительно улучшает доступ к данным.
