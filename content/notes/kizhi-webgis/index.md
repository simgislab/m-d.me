...
Отдельно сделанные фотографии с координатами, прописанными в них, были превращены в слой данных с помощью инструмента [Фото с EXIF в слой Веб ГИС](https://toolbox.nextgis.com/operation/exif2resource).

Фотографии, у которых не было координат в EXIF, но было точное время съемки, были привязаны к карте с помощью треков и инструмента [Добавление координат к фотографиям](https://toolbox.nextgis.com/t/gpx2exif).
